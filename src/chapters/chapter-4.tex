...
\begin{table}[ht]
    ...
    \begin{tabularx}{\textwidth}{|Y|X|X|}
        \hline
        \textbf{Contoh kata masukan} & \multicolumn{1}{Y|}{\textbf{Contoh keluaran metode \parencite{saragih2017normalisasi}}} & \multicolumn{1}{Y|}{\textbf{Contoh keluaran metode usulan}} \\ \hline
